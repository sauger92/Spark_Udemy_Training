object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(416); 
  ...
  def upperCase(str: String) = {
  
  		str.toUpperCase
  };System.out.println("""upperCase: (str: String)String""");$skip(32); 
  
  println(upperCase("test"));$skip(47); 
  
  println({val x = "test2"; x.toUpperCase})}
