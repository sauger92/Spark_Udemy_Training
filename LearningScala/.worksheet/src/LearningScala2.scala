object LearningScala2 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(141); 
  ...
  do { println(x); x+=1 } while (x <= 10);$skip(154); val res$0 = 
   ...
   {val x = 10; x + 20};System.out.println("""res0: Int = """ + $show(res$0));$skip(82); 
	 ...
	 var i = 0;System.out.println("""i  : Int = """ + $show(i ));$skip(15); 
	 var first =0;System.out.println("""first  : Int = """ + $show(first ));$skip(17); 
	 var second = 1;System.out.println("""second  : Int = """ + $show(second ));$skip(15); 
	 print(first);$skip(14); 
	 var tmp = 0;System.out.println("""tmp  : Int = """ + $show(tmp ));$skip(108); 
